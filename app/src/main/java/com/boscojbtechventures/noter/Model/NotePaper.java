...
public class NotePaper extends AppCompatEditText {
    ...
    public NotePaper(final Context context) {
        super(context);
        init();
    }

    public NotePaper(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NotePaper(Context context, AttributeSet attrs, int defStyleAttr) {
